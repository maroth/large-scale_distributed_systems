...
set output "plots/plot_3-2_h0s0_indegrees.eps"
set title "In-degree Distribution for H=0 S=0"
...
plot "log_3-2_check_indegrees_output_h0s0.txt" u ($1):($2) with boxes title ""
