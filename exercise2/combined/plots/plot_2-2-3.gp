...
set output "plots/plot_2-2-3.eps"
...
plot "aggregated_log_2-2-3_htl4_f3.txt" u ($2):($3) with lines linestyle 1 title "HTL=4 f=3 (56 duplicates)", \
     "aggregated_log_2-2-3_htl5_f2.txt" u ($2):($3) with lines linestyle 2 title "HTL=5 f=2 (20 duplicates)", \
     "aggregated_log_2-2-3_htl5_f3.txt" u ($2):($3) with lines linestyle 3 title "HTL=5 f=3 (23 duplicates)", \
     "aggregated_log_2-2-3_htl5_f4.txt" u ($2):($3) with lines linestyle 4 title "HTL=5 f=4 (357 duplicates)", \
     "aggregated_log_2-2-3_htl5_f8.txt" u ($2):($3) with lines linestyle 5 title "HTL=5 f=8 (1001 duplicates)"
