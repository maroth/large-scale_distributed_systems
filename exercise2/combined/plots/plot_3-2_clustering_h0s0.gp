...
set output "plots/plot_3-2_h0s0_clustering.eps"
set title "Clustering Distribution for H=0 S=0"
...
plot "log_3-2_check_clustering_output_h0s0.txt" u ($2):($1) with boxes title ""
