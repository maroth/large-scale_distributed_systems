...
set output "plots/plot_3-2_h4s0_clustering.eps"
set title "Clustering Distribution for H=4 S=0"
...
plot "log_3-2_check_clustering_output_h4s0.txt" u ($2):($1) with boxes title ""
