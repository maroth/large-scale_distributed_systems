...
set output "plots/plot_3-2_h0s4_clustering.eps"
set title "Clustering Distribution for H=0 S=4"
...
plot "log_3-2_check_clustering_output_h0s4.txt" u ($2):($1) with boxes title ""
