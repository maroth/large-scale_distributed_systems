...
set output "plot_seconds.png"
set title "Dissemination"
...
plot "aggregated_log.txt" u ($1):($3) with lines linestyle 3 title "infected nodes", \
     "aggregated_log.txt" u ($1):($6) with lines linestyle 4 title "infected by anti-entropy", \
     "aggregated_log.txt" u ($1):($7) with lines linestyle 5 title "infected by rumor mongering"

     # "aggregated_log.txt" u ($1):(100*$4) with lines linestyle 1 title "% infected nodes", \
     # "aggregated_log.txt" u ($1):($5) with lines linestyle 2 title "duplicate messages", \
