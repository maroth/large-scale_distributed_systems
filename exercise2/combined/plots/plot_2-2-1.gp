...
set output "plots/plot_2-2-1.eps"
...
set xrange [0:2] # example of a range closed on one side only, the max will determined automatically

plot "aggregated_log_2-2-1.txt" u ($2):($3) with lines linestyle 1 title "infected nodes"
